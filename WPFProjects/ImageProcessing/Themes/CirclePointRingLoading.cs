...
namespace ImageProcessing.Themes
{
    ...
    {
        private readonly string StateActive = "Active";
        private readonly string StateInActive = "InActive";
        private readonly string StateLarge = "Large";
        private readonly string StateSmall = "Small";
        ...
        {
            if (dependencyObject is not CirclePointRingLoading ring)
                return;
        ...
        {
            if (sender is not CirclePointRingLoading loading)
            {
                return;
            }
